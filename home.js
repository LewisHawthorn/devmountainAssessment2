...
// CODE HERE
const deliveryAreaZipCodes = [85205, 85204, 85203, 85213, 85206]
canWeDeliverTwo = (zipCode) => {let x =
  deliveryAreaZipCodes.some(checkCode);
  function checkCode(code) {return code === zipCode}
if (x === true)
return `You're in our delivery zone!`
else return `Sorry, we can't deliver to that address`
}
// console.log(canWeDeliverTwo(8204))
//////////////////PROBLEM 3////////////////////
/* 
